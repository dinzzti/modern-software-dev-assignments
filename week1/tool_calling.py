...
# TODO: Fill this in!
YOUR_SYSTEM_PROMPT = """
You are an AI assistant that MUST use the available tool.
You have access to a tool named 'output_every_func_return_type'.

When the user says "Call the tool now", you must return ONLY a JSON object like this:
{
