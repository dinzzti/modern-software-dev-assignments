...
You MUST use the provided Context to write the code.
Do not hallucinate URLs or headers not found in the Context.
"""
...
def YOUR_CONTEXT_PROVIDER(corpus: List[str]) -> List[str]:
    """
    RAG Task: We must feed the 'corpus' (api_docs.txt) to the AI
    so it knows the API endpoint and headers.
    """
    return corpus
